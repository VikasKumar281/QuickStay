  ...
  return (
    <div className="flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30">
        <div className='flex flex-col md:flex-row items-center justify-between w-full'>
            <Title align="left" title="Exclusive Offers" subTitle="Take advatage of our limited-time offers and special packages to enhance your stay and
            ...
            <div key ={item._id} className='group relative flex flex-col items-start justify-between
              gap-1 pt-12 md:pt-18 px-4 rounded-xl text-white bg-no-repeat bg-cover bg-center'style ={{backgroundImage: `url(${item.image})`}} >
               ...
               <div>
                ...
                <button className='invert group-hover:translate-x-1 transition-all'>
                   View Offers 
                   <img 
